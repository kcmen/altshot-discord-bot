...
@app_commands.command(name="matchup", description="Show your matchup for the current week")
@app_commands.describe(team="Your team name (e.g. T5)")
async def matchup(interaction: discord.Interaction, team: str):
    ...
    for t1, t2 in matchups:
        if team == t1 or team == t2:
            ...
            await interaction.response.send_message(f"📌 **Week {week} Matchup:**\n🟢 *{name1} ({t1})* vs 🔵 *{name2} ({t2})*")
            return
